...
<main class="container">
  <section class="steps">
    ...
    <div class="step active">05. Paiement</div>
  </section>
  <table>
    <thead>
      <tr>
  ...
  <section class="summary">
    <div><strong>Total Produits :</strong> <?= number_format($total_products_converted, 2) ?> <?= e($selectedCurrency ?? 'MAD') ?></div>
    <div><strong>Total Livraison :</strong> <?= number_format($total_shipping_converted, 2) ?> <?= e($selectedCurrency ?? 'MAD') ?></div>
